...
class PCA():
    ...
    def __init__(self, get_devices=False):
        ...
        self.parse(ser.readline().decode('utf-8'))
    ...
    def get_devices(self, refresh=False, generic_type=None):
        """Get all devices from the jeelink."""
        print("try to get devices")
